...
std::string _LibvirtStorageVolume::get_key() { return virStorageVolGetKey(get_handle()); }
std::string _LibvirtStorageVolume::get_name() { return virStorageVolGetName(get_handle()); }
std::string _LibvirtStorageVolume::get_path() { return virStorageVolGetPath(get_handle()); }

virStorageVolInfo _LibvirtStorageVolume::get_info(std::vector<virStorageVolInfoFlags> flags) {
...
virStorageVolType _LibvirtStorageVolume::get_type() { return static_cast<virStorageVolType>(get_info().type); }
std::uint64_t _LibvirtStorageVolume::get_capacity() { return get_info().capacity; }
std::uint64_t _LibvirtStorageVolume::get_allocation() { return get_info().allocation; }

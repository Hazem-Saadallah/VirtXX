...
VirtXX::Impl::_LibvirtConnection::_LibvirtConnection(virConnectPtr connection_ptr) : m_Handle(connection_ptr, Deleters::_LibvirtConnectionPtrDeleter()) { }
VirtXX::Impl::_LibvirtConnection::_LibvirtConnection(const std::string& uri)
...
VirtXX::Impl::_LibvirtConnection::~_LibvirtConnection() = default; /* defined in here becasue the unique poiter is initialized here.*/

VirtXX::Impl::_LibvirtConnection::operator bool() const { return m_Handle != nullptr; }

void VirtXX::Impl::_LibvirtConnection::report_error(_datatype::ErrorCode_t code, _datatype::ErrorMsg_t msg) {
  m_LastError = _ErrorBlock(code, msg);
}

virConnectPtr VirtXX::Impl::_LibvirtConnection::get_handle() const { return m_Handle.get(); }

VirtXX::Impl::_ErrorBlock VirtXX::Impl::_LibvirtConnection::get_last_error() const { return m_LastError; }

VirtXX::Impl::_datatype::_LibvirtInternalErrorPtr VirtXX::Impl::_LibvirtConnection::get_last_libvirt_error() const {
  return _datatype::_LibvirtInternalErrorPtr(virSaveLastError(), Deleters::_LibvirtErrorPtrDeleter());
}

std::int32_t VirtXX::Impl::_LibvirtConnection::get_domain_count(std::vector<virConnectListAllDomainsFlags> flags) {
...
VirtXX::Impl::_datatype::_DomainList VirtXX::Impl::_LibvirtConnection::get_domains(std::vector<virConnectListAllDomainsFlags> flags) {
...
VirtXX::Impl::_LibvirtDomain VirtXX::Impl::_LibvirtConnection::get_domain_by_id(std::int32_t id) const {
  return _LibvirtDomain(_LibvirtConnectionCreationKey{}, virDomainLookupByID(get_handle(), id));
}

VirtXX::Impl::_LibvirtDomain VirtXX::Impl::_LibvirtConnection::get_domain_by_name(const std::string& domain_name) const {
  return _LibvirtDomain(_LibvirtConnectionCreationKey{}, virDomainLookupByName(get_handle(), domain_name.c_str()));
}

std::int32_t VirtXX::Impl::_LibvirtConnection::get_active_storage_pool_count() {
  return virConnectNumOfStoragePools(get_handle());
}

std::int32_t VirtXX::Impl::_LibvirtConnection::get_defined_storage_pool_count() {
  return virConnectNumOfDefinedStoragePools(get_handle());
}

VirtXX::Impl::_datatype::_StoragePoolList VirtXX::Impl::_LibvirtConnection::get_storage_pools(std::vector<virConnectListAllStoragePoolsFlags> flags) {
...
VirtXX::Impl::_LibvirtStoragePool VirtXX::Impl::_LibvirtConnection::get_storage_pool_by_name(std::string name) {
...
VirtXX::Impl::_LibvirtStoragePool VirtXX::Impl::_LibvirtConnection::get_storage_pool_by_target_path(std::string path) {
  REPORT_AND_RETURN_IF_NULL_HANDLE(_LibvirtStoragePool(_LibvirtConnectionCreationKey{}, nullptr));
...
VirtXX::Impl::_LibvirtStoragePool VirtXX::Impl::_LibvirtConnection::get_storage_pool_by_uuid_string(std::string uuid_str) {
  REPORT_AND_RETURN_IF_NULL_HANDLE(_LibvirtStoragePool(_LibvirtConnectionCreationKey{}, nullptr));
...
VirtXX::Impl::_LibvirtStoragePool VirtXX::Impl::_LibvirtConnection::get_storage_pool_by_uuid(_datatype::_UUIDBytes uuid) {
  REPORT_AND_RETURN_IF_NULL_HANDLE(_LibvirtStoragePool(_LibvirtConnectionCreationKey{}, nullptr));
...
VirtXX::Impl::_LibvirtStorageVolume VirtXX::Impl::_LibvirtConnection::get_volume_by_key(std::string key) {
...
VirtXX::Impl::_LibvirtStorageVolume VirtXX::Impl::_LibvirtConnection::get_volume_by_path(std::string path) {
  REPORT_AND_RETURN_IF_NULL_HANDLE(_LibvirtStorageVolume(_LibvirtConnectionCreationKey{}, nullptr));
...
VirtXX::Impl::_LibvirtStoragePool VirtXX::Impl::_LibvirtConnection::create_transient_storage_pool(const std::string& xml_config, std::vector< virStoragePoolCreateFlags> flags) {
  REPORT_AND_RETURN_IF_NULL_HANDLE(_LibvirtStoragePool(_LibvirtConnectionCreationKey{}, nullptr));
...
VirtXX::Impl::_LibvirtStoragePool VirtXX::Impl::_LibvirtConnection::create_persistent_storage_pool(const std::string& xml_config, std::vector<virStoragePoolDefineFlags> flags) {
  REPORT_AND_RETURN_IF_NULL_HANDLE(_LibvirtStoragePool(_LibvirtConnectionCreationKey{}, nullptr));

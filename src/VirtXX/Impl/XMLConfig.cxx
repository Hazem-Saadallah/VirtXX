...
std::string VirtXX::Impl::XMLConfig::BasicStoragePool(std::string name, std::string target_path, std::string type) {
...
std::string VirtXX::Impl::XMLConfig::BasicStorageVolume(std::string name, std::string capacity_unit, std::string capacity, std::string allocation, std::string target_format_type, std::string type) {
  pugi::xml_document document;

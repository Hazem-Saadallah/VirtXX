...
namespace VirtXX {
  namespace Config {
    namespace Impl{
      class StorageVolumeConfig : BaseConfig {
      public:
      ...
      private:
        std::unordered_map<Config::Impl::StorageVolumeConfig::Field, std::variant<ConfigValue<std::string>, ConfigValue<std::uint64_t>>> m_Values = {
          {StorageVolumeConfig::Field::TYPE, ConfigValue<std::string>({""}, Config::Impl::Datatype::get_storage_volume_type_string(Config::Impl::Datatype::StorageVolumeType::FILE))},
          {StorageVolumeConfig::Field::NAME, ConfigValue<std::string>({""}, VirtXX::Impl::Misc::generate_random_string(10, "VirtXX_VOLUME_", ""))},
          {StorageVolumeConfig::Field::CAPACITY, ConfigValue<std::uint64_t>({""}, 0)},
          {StorageVolumeConfig::Field::CAPACITY_UNIT, ConfigValue<std::string>({""}, Config::Impl::Datatype::get_storage_unit_string(Config::Impl::Datatype::StorageUnit::BYTES))},
          {StorageVolumeConfig::Field::ALLOCATION, ConfigValue<std::uint64_t>({""}, 0)},
          {StorageVolumeConfig::Field::ALLOCATION_UNIT, ConfigValue<std::string>({""}, Config::Impl::Datatype::get_storage_unit_string(Config::Impl::Datatype::StorageUnit::BYTES))},
          {StorageVolumeConfig::Field::TARGET_FORMAT_TYPE, ConfigValue<std::string>({""}, Config::Impl::Datatype::get_file_format_type_string(Config::Impl::Datatype::FileFormatType::RAW))},
        };
